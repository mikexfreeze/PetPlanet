package com.petplanet.company.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.petplanet.company.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.petplanet.company.repository.UserRepository.USERS_BY_EMAIL_CACHE);
