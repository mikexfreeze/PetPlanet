...
export const Post = (props: IPostProps) => {
  ...
  return (
    <div>
      <h2 id="post-heading">
        <Translate contentKey="petPlanetApp.post.home.title">Posts</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="petPlanetApp.post.home.createLabel">Create new Post</Translate>
        </Link>
      </h2>
        ...
        {postList && postList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="petPlanetApp.post.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('content')}>
                  <Translate contentKey="petPlanetApp.post.content">Content</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('created')}>
                  <Translate contentKey="petPlanetApp.post.created">Created</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="petPlanetApp.post.home.notFound">No Posts found</Translate>
            </div>
          )
        )}
      </div>
