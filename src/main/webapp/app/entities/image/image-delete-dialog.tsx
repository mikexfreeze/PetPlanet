...
export const ImageDeleteDialog = (props: IImageDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="petPlanetApp.image.delete.question">
        <Translate contentKey="petPlanetApp.image.delete.question" interpolate={{ id: imageEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-image" color="danger" onClick={confirmDelete}>
